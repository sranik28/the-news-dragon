        ...
        children: [
            {
                path: ":id",
                element: <Category />,
                loader: ({ params }) => fetch(`https://the-news-dragon-server-site-sranik28.vercel.app/categories/${params.id}`)
        ...
        children: [
            {
                ...
                loader: ({ params }) => fetch(`https://the-news-dragon-server-site-sranik28.vercel.app/news/${params.id}`)
            },
